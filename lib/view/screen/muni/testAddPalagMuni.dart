// ignore_for_file: unused_local_variable, file_names, deprecated_member_use, avoid_print, prefer_const_constructors

import 'dart:async';

import 'package:balag/controller/muni/addPalagMuni_Controller.dart';
...
class TestMuni extends StatefulWidget {
  const TestMuni({super.key});

  @override
  State<TestMuni> createState() => _TestMuniState();
}

class _TestMuniState extends State<TestMuni> {
  @override
  Widget build(BuildContext context) {
    AddPalagMuniController controller = Get.put(AddPalagMuniController());
    return Scaffold(
        appBar: AppBar(
        ...
        body: GetBuilder<AddPalagMuniController>(
          builder: (controller) {
            return Container(
