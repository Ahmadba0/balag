...
import 'package:balag/controller/muni/muniPage_controller.dart';
...
class MuniPage extends StatefulWidget {
  const MuniPage({super.key});

  @override
  State<MuniPage> createState() => _MuniPageState();
}

class _MuniPageState extends State<MuniPage> {
  @override
  Widget build(BuildContext context) {
    Get.put(MuniPageController());
    return Scaffold(
      appBar: AppBar(
      ...
      floatingActionButton: CustomFloatButton(
        ...
        onPressed: () {
          print("welcome to add muni");
          Get.to(TestMuni());
        },
      ),
      body: GetBuilder<MuniPageController>(
        builder: (controller) {
